---
title: Gratuity
url: https://docs.frappe.io/hr/gratuity
---
...
In Frappe HR you can manage Gratuity Payments of employee, based on different [Gratuity Rule](https://docs.frappe.io/hr/gratuity-rule) which vary from region to region.
